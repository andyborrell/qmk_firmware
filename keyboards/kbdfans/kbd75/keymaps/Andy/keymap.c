...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ML] = LAYOUT(
        ...
        __________, RGB_HUI,RGB_MOD, RGB_MODE_PLAIN,  RGB_VUI, _______, _______, KC_P1, KC_P2, KC_P3, _______, _______, KC_PENT, _______,              // 14 keys
        BL_INC, _______, RGB_TOG, KC_PAST, KC_CALC, _______, _______, _______, KC_NLCK, KC_P0, KC_PDOT, KC_PSLS, __________, KC_VOLU, _______, // 14 keys
